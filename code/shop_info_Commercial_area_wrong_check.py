...
if __name__ == '__main__':
    ...
    debug_menu =[]
    debug_menu.append(["徐汇区","自助餐","http://www.dianping.com/shanghai/ch10/g111r2"])
    ...
    #for each_url in menu_list:
        ...
        while except_fail_num < 3:
            try:
                ...
                get_Shop_Info(driver,shop_catagory,happen_except,cur_page,shoplist_or_eachShop,'shanghai',each_url[0])
                ...
                record_info = 'except the same page for twice: ' + str(cur_page) + '  ' + each_url[0]+'  ' +shop_catagory + '  '+ str(shop_num) + each_url[1] + '  '+ "\n"
        ...
        if write_to_db == True and len(all_shops) > 0:
            ...
            success_info = 'insert finish: ' + shop_catagory + ' max page: '+ str(max_page) + ' valid page: '+ str(insert_page) + "\n"
            with open(file_except, 'a+', encoding="utf-8") as f:
